package vn.karaokeplayer.lyricseditor.controls {
    ...
    *******************************/
        ...
        * objects, since addChildAt doesn't work for higher numbers) */
        ...
        private static var hoverObjects:Dictionary;
    ...
    *******************************/
        ...
        private static function showTip(e: Event): void {
        ...
        public static function init(st: Stage, opt: Object): void {
			...
			trace('_displayOptions.textAlign: ' + (_displayOptions.textAlign));
		...
		static protected function mouseMoveHandler(event: MouseEvent): void {
			if (_visible == false) return;
			setTooltipToMouse(event.stageX, event.stageY);
